class script(object):
    START_TXT = """<b> 🌟 𝓗𝓮𝓵𝓵𝓸, {} 𝓓𝓪𝓻𝓵𝓲𝓷𝓰 ! {}
<blockquote>✨ 𝐈’𝐦 𝐭𝐡𝐞 𝐦𝐨𝐬𝐭 𝐚𝐝𝐯𝐚𝐧𝐜𝐞𝐝, 𝐀𝐈-𝐩𝐨𝐰𝐞𝐫𝐞𝐝 𝐀𝐔𝐓𝐎-𝐅𝐈𝐋𝐓𝐄𝐑 𝐁𝐎𝐓 !  

🎬 𝐃𝐫𝐨𝐩 𝐚𝐧𝐲 𝐌𝐎𝐕𝐈𝐄 or 𝐒𝐄𝐑𝐈𝐄𝐒 𝐧𝐚𝐦𝐞 – 𝐚𝐧𝐝 𝐰𝐚𝐭𝐜𝐡 𝐦𝐲 𝐌𝐀𝐆𝐈𝐂 🪄 </blockquote>
<blockquote>📌 𝐅𝐨𝐫 𝐦𝐨𝐫𝐞 𝐝𝐞𝐭𝐚𝐢𝐥𝐬, 𝐮𝐬𝐞 𝐭𝐡𝐞 𝐛𝐮𝐭𝐭𝐨𝐧𝐬 𝐛𝐞𝐥𝐨𝐰 🔰</blockquote>

🪄 𝐌𝐚𝐢𝐧𝐭𝐚𝐢𝐧𝐞𝐝 𝐛𝐲 :<blockquote> <a href='https://t.me/+55RV97igBkQ4ZmVl'>ꕮ 𝐃𝐫𝐚𝐦𝐚 𝐥𝐨𝐯𝐞𝐫𝐱 ꕮ 💞</a></blockquote>
"""
...
ᴇx: <code>/fsub -1002443724776</code>
...
💀 Powered by : <a href="https://t.me/Real_Pirates">𝐑𝐞𝐚𝐥_𝐏𝐢𝐫𝐚𝐭𝐞𝐬</a>
</b>"""
...
ᴘʟᴇᴀsᴇ ᴊᴏɪɴ ᴏᴜʀ ʀᴇǫᴜᴇsᴛ ɢʀᴏᴜᴘ ᴛᴏ ɢᴇᴛ ✨</b>'''
    ...
    REF_LINK = '''🔗 <b>💥 ʜᴇʀᴇ ɪs ᴏᴜʀ ʀᴇғᴇʀʀᴀʟ ʟɪɴᴋ: 

<code>https://telegram.me/{}?start=biisal-{}</code></b>

𝚃𝚊𝚙 𝚝𝚘 𝚌𝚘𝚙𝚢 👆 & 𝚂𝚑𝚊𝚛𝚎 𝚒𝚝 𝙼𝚊𝚡 😘

<blockquote>👥 Fᴏʀ ᴇᴠᴇʀʏ ɴᴇᴡ ᴜsᴇʀ ᴡʜᴏ sᴛᴀʀᴛs ᴛʜᴇ ʙᴏᴛ ᴜsɪɴɢ ᴛʜɪs ʟɪɴᴋ, ʏᴏᴜ ᴡɪʟʟ ʀᴇᴄᴇɪᴠᴇ <b>100 ᴘᴏɪɴᴛs 🎁</b></blockquote>

🎉 <b>ᴏɴᴄᴇ ʏᴏᴜ ʀᴇᴀᴄʜ <i>{}</i> ᴘᴏɪɴᴛs, ʏᴏᴜ ᴡɪʟʟ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ɢᴇᴛ ᴘʀᴇᴍɪᴜᴍ ᴀᴄᴄᴇss 😉</b>'''
    ...
    REF_START = '''<b>Hurray 🥳 {} ,sᴛᴀʀᴛᴇᴅ ᴛʜᴇ ʙᴏᴛ ᴜsɪɴɢ ʏᴏᴜʀ ʀᴇғᴇʀʀᴀʟ ʟɪɴᴋ
...
❀━━┅━━━┅━━┅━━━┅━━❀
  Provided by ⭛
<b><spoiler><blockquote>ཐིཋྀ @Drama_Loverx ཐིཋྀ</blockquote></spoiler> 🌝</b>
"""
...
‼️ ᴄʟɪᴄᴋ ᴏɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ ᴛᴏ ᴄʜᴇᴄᴋ ᴀʟʟ ᴀᴠᴀɪʟᴀʙʟᴇ ᴘʟᴀɴs & ɪᴛ's ᴘʀɪᴄᴇs</b>"""
    ...
    BUY_PLAN = """<b>○ <u>sᴛᴇᴘ 1️⃣</u> : ᴘᴀʏ ᴛʜᴇ ᴀᴍᴏᴜɴᴛ ᴀᴄᴄᴏʀᴅɪɴɢ ᴛᴏ ʏᴏᴜʀ ғᴀᴠᴏʀɪᴛᴇ ᴘʟᴀɴ ᴛᴏ ᴛʜɪs

<blockquote><code>9302766545-3@ybl</code> ᴜᴘɪ ɪᴅ.</blockquote>
    
○ <u>sᴛᴇᴘ 2️⃣</u> : ᴛᴀᴋᴇ ᴀ sᴄʀᴇᴇɴsʜᴏᴛ ᴏғ ʏᴏᴜʀ ᴘᴀʏᴍᴇɴᴛ ᴀɴᴅ sʜᴀʀᴇ ɪᴛ ᴅɪʀᴇᴄᴛʟʏ ʜᴇʀᴇ: @Movie_Pirates_x 
...
#verified_{}_completed"""
    ...
    MOVIES_UPDATE_TXT = """<b>#New_File_Added ✅🏴‍☠️</b>

<b><blockquote><b>⎈ <a href='https://t.me/Real_Pirates'>{title}</a></blockquote></b>
<b><blockquote>🖼 Genre: {genres}</blockquote></b>
<b><blockquote expandable>📝 Description: {description}</blockquote></b>
┈݆─݆─݆─݆┈݆─݆─݆─݆┈݆─݆─݆─݆┈݆─݆─݆─݆┈݆─݆─݆─݆
<b><blockquote><a href='https://t.me/Real_Pirates/95'>╔════════════╗ 
╠➪ 𝐇𝐎𝐖 𝐓𝐎 𝐉𝐎𝐈𝐍 🦜 
╚════════════╝</a></b></blockquote>
⥥⥥⥥⥥⥥⥥⥥⥥⥥⥥⥥⥥⥥⥥⥥⥥⥥⥥⥥
"""
